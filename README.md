...
- **总计**: 116 篇
- **会议分布**: ASPLOS 4 篇（'22–'26），OSDI 112 篇（'26）
- **领域分布**:
  ...
  - 云基础设施/虚拟化: 9 篇（mwait-sched, Xkernel, Janus, Nested SEV, PowerSight, M3U, Quark, DVLA, PIMS） — 见 `operations/cloud-infrastructure/KNOWLEDGE.md`
