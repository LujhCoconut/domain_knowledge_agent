...
- **总计**: 119 篇
- **会议分布**: ASPLOS 4 篇（'22–'26），OSDI 115 篇（'26）
- **领域分布**:
  ...
  - 云基础设施/虚拟化: 10 篇（mwait-sched, Xkernel, Janus, Nested SEV, PowerSight, M3U, Quark, DVLA, PIMS, ASI-Heterogeneity） — 见 `operations/cloud-infrastructure/KNOWLEDGE.md`
  ...
  - 缓存算法: 1 篇（Merlin） — 见 `algorithms/cache-algorithms/KNOWLEDGE.md`
