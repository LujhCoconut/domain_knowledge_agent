...
- **总计**: 140 篇
- **会议分布**: ASPLOS 4 篇（'22–'26），FAST 1 篇（'26），OSDI 133 篇（'26），SOSP 2 篇（'25）
- **领域分布**:
  ...
  - 云原生/解耦式服务: 6 篇（DGC, OpenTela, Arca, Spice, libDSE, Latte） — 见 `architecture/cloud-native/KNOWLEDGE.md`
  ...
  - 存储/文件系统: 10 篇（ByteDance DataPipeline, DeLFS, Espresso, FORGE, Oxbow, DINGO, Umap, Helmsman, WiseCode, Latte） — 见 `performance/storage-filesystem/KNOWLEDGE.md`
