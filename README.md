...
- **总计**: 109 篇
- **会议分布**: ASPLOS 4 篇（'22–'26），OSDI 105 篇（'26）
- **领域分布**:
  ...
  - 云基础设施/虚拟化: 7 篇（mwait-sched, Xkernel, Janus, Nested SEV, PowerSight, M3U, Quark） — 见 `operations/cloud-infrastructure/KNOWLEDGE.md`
  - 云原生/解耦式服务: 4 篇（DGC, OpenTela, Arca, Spice） — 见 `architecture/cloud-native/KNOWLEDGE.md`
  ...
  - 加速器架构与编译: 1 篇（TileLoom） — 见 `architecture/accelerators/KNOWLEDGE.md`
